...
This should take a list with 0 as only element and then zip the commands to change the bits and add it to the end of the list and then call thue again. 

 thuer [] = []
 thuer (0:list) = 1 : thuer list
 thuer (1:list) = 0 : thuer list
 thue list = [list | list <- zip (thuer list) (thue list)]
 thueSeq = thue [0]
